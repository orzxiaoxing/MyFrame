...
public class SendMail {
	...
	public String myEmailAccount = "824101559@qq.com";
	public String myEmailPassword = "wdteppkqfiodbajh";

	// 发件人邮箱的 SMTP 服务器地址, 必须准确, 不同邮件服务器地址不同, 一般(只是一般, 绝非绝对)格式为: smtp.xxx.com
	// 网易163邮箱的 SMTP 服务器地址为: smtp.163.com QQ邮箱为smtp.qq.com 在各大邮箱的设置中能够找到。
	public String myEmailSMTPHost = "smtp.qq.com";
	// 收件人邮箱（替换为自己知道的有效邮箱）
	public String receiveMailAccount = "824101559@qq.com";
	// 昵称,尽量设定，避免被识别为垃圾邮件
	public String nickname="星之所在";
	// 抄送名单
	public String copyMailAccount = "";
	// 标题
	public String title = "测试框架邮件";
	// 属性
